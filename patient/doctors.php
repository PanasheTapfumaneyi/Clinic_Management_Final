...
<body>
    ...
    // Determine the account type value
$accountTypeValue = 0; // Default value

if ($paccounttype === "Practitioner") {
    $accountTypeValue = 2;
} elseif ($paccounttype === "GP") {
    $accountTypeValue = 1;
}
...
?>
                ...
                <?php
                    if ($_POST) {
                        ...
                        // Updated SQL query to include the specialty condition
                        $sqlmain = "SELECT * FROM doctor 
                                    WHERE (docemail='$keyword' OR 
                                           docname='$keyword' OR 
                                           docname LIKE '$keyword%' OR 
                                           docname LIKE '%$keyword' OR 
                                           docname LIKE '%$keyword%') 
                                    AND specialties = '$accountTypeValue'"; // Filter by specialty
                    } else {
                        $sqlmain = "SELECT * FROM doctor 
                                    WHERE specialties = '$accountTypeValue' 
                                    ORDER BY docid DESC"; // Default query filtering by specialty
                    }
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="text" name="nic" class="input-text" placeholder="MediCare Number" value="'.$nic.'" required><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
