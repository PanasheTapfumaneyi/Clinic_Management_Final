...
<body>
    ...
    // Store scheduleID in session if it's present in the URL
if (isset($_GET['id'])) {
    $_SESSION['scheduleID'] = $_GET['id'];
}
                ...
                <tr >
                    ...
                    <td >
                            <form action="schedule.php" method="post" class="header-search">
                                        ...
                                        $list12 = $database->query(
                                            "select DISTINCT * from  schedule GROUP BY title;"
                                        );
                            ...
                            <?php if ($_GET) {
                                if (isset($_GET["id"])) {
                                    ...
                                    echo '
                                        ...
                                        $scheduleid .
                                        '" >
                                            <input type="hidden" name="apponum" value="' .
                                        $apponum .
                                        '" >
